...
<script Language="JavaScript">  
    ...
    $("body").on('submit', '#formContacto', function(event) {
		...
		<iframe src="https://docs.google.com/forms/d/e/1FAIpQLSeVzPrWvjX6KNvYk8CDQ3DfyZp9uio6iUX3k1FU8sn16vFgwQ/viewform?embedded=true" width="760" height="500" frameborder="0" marginheight="0" marginwidth="0">Loading...</iframe>
